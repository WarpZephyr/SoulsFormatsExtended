...
{
    /// <summary>
    /// A general-purpose single compressed file wrapper.
    /// <para>Seen used in DeS, ACE:R, DS1, ACV, ACVD, DS2, BB, DS3, DSR, Sekiro, ER, and AC6.</para>
    /// </summary>
    public static class DCX
    {
        ...
        /// <summary>
        /// Returns true if the bytes appear to be a <see cref="DCX"/> file.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if the file appears to be a <see cref="DCX"/> file.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if the <see cref="BinaryReaderEx"/> appears to be a <see cref="DCX"/> file.
        /// </summary>
        ...
        /// <summary>
        /// Decompress a <see cref="DCX"/> file from a <see cref="BinaryReaderEx"/> and return the detected <see cref="DCX"/> type.
        /// </summary>
        ...
        /// <summary>
        /// Decompress data from DCP deflate.
        /// </summary>
        ...
        /// <summary>
        /// Decompress data from DCX deflate.
        /// </summary>
        ...
        /// <summary>
        /// Decompress data from DCX krak using Oodle.
        /// </summary>
        ...
        /// <summary>
        /// Compress a <see cref="DCX"/> file to an array of bytes using the specified <see cref="DCX"/> type.
        /// </summary>
        ...
        /// <summary>
        /// Compress a <see cref="DCX"/> file to the specified path using the specified <see cref="DCX"/> type.
        /// </summary>
        ...
        /// <summary>
        /// Compress a <see cref="DCX"/> file to a <see cref="BinaryWriterEx"/> using the specified <see cref="DCX"/> type.
        /// </summary>
        ...
        /// <summary>
        /// Compress data to DCX krak using Oodle.
        /// </summary>

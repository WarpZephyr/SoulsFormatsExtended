...
namespace SoulsFormats
{
    public partial class FLVER2
    {
        ...
        internal class EdgeIndexBuffer
        {
            ...
            internal void GetFaceIndices(BinaryReaderEx br, long groupStartOffset, List<int> faceIndices)
            {
                ...
                for (int j = 0; j < SpuConfigInfo.NumIndexes; j++)
                    faceIndices.Add(indexes[j] + BaseIndex);
            }

            /// <summary>
            /// Decompress the edge SPU face indices into an array of <see cref="ushort"/>.
            /// </summary>
            /// <param name="br">The stream reader.</param>
            /// <param name="numIndexes">The number of indices.</param>
            /// <returns>The decompressed face indices.</returns>
            private static ushort[] DecompressIndexes(BinaryReaderEx br, int numIndexes)
            {

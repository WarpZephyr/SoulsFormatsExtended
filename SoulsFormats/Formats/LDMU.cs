...
namespace SoulsFormats
{
    ...
    public class LDMU
    {
        ...
        /// <summary>
        /// Reads a <see cref="LDMU"/> from the specified streams.
        /// </summary>
        /// <param name="headerStream">A <see cref="Stream"/> with the current position starting with an <see cref="LDMU"/> header.</param>
        /// <param name="dataStream">A <see cref="Stream"/> with the current position starting with a <see cref="LDMU"/> data file.</param>
        /// <param name="leaveHeaderStreamOpen">Whether or not to leave the header stream open after reading is finished.</param>
        /// <returns>The read <see cref="LDMU"/>.</returns>
        public static LDMU Read(Stream headerStream, Stream dataStream, bool leaveHeaderStreamOpen = false)
        {
            using var br = new BinaryReaderEx(false, headerStream, leaveHeaderStreamOpen);
        ...
        /// <summary>
        /// Whether or not the data at the current position of a <see cref="Stream"/> is an <see cref="LDMU"/> or not.
        /// </summary>
        /// <param name="stream">A <see cref="Stream"/>.</param>
        /// <returns>Whether or not the <see cref="Stream"/> starts with an <see cref="LDMU"/> at the current position.</returns>
